...
const Navbar = () => {
    ...
    return (
        <nav className="flex justify-between items-center bg-BlueCenter py-5 px-20 shadow-lg w-full">
            ...
            <div className="">
                <ul className={` flex-col items-start justify-start fixed top-[75px] right-0 w-80 h-screen bg-blue-900 shadow-lg pt-10 pl-0 pb-0 pr-3 text-white font-medium
            md:flex-row md:relative md:w-auto md:h-auto md:bg-transparent md:p-0 md:top-0 md:shadow-none ${menu? "hidden" : "flex" }` }>
