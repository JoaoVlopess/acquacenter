...
const Navbar = () => {
    ...
    return (
        <nav className="flex justify-between items-center bg-BlueCenter py-5 px-20 shadow-lg w-full">
            ...
            <div className="">
                <ul className={` flex flex-col items-start justify-start fixed top-[76px] right-0 w-60 h-full opacity-100 bg-blue-900 shadow-lg pt-10 pl-0 pb-0 pr-3 text-white font-medium
            md:flex-row md:relative md:w-auto md:h-auto md:bg-transparent md:p-0 md:top-0 md:shadow-none z-50 ${menu? "left-[-320px]" : "left-0" }  transition-all duration-300 ease-in-out` }>
