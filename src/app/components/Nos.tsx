        ...
        className="w-[85%] block m-auto">
          ...
          className="float-none w-full  text-center lg:w-1/2 lg:float-left lg:text-left">
            ...
            <div className="">
              ...
              <p className=" mt-3  md:text-lg lg:text-xl  pr-0 md:pr-9 text-TextProd"
              >
          ...
          >
            <img 
            className="justify-self-center w-[75%] h-[75%] lg:w-full lg:h-full shadow-2xs shadow-[0px_0px_8px_2px_rgba(0,0,0,0.4)]"
